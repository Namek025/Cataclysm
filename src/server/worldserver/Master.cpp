...
int Master::Run()
{
	...
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "  __        __ __        ___               ____                 ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "  \\ \\      / /_\\ \\      / / \\   _ __ __ _ / ___|___  _ __ ___   ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "   \\ \\ /\\ / / _ \\ \\ /\\ / / _ \\ |  __/ _  | |   / _ \\|  __/ _ \\  ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "    \\ V  V / (_) \\ V  V / ___ \\| | | (_| | |__| (_) | | |  __/  ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "     \\_/\\_/ \\___/ \\_/\\_/_/   \\_\\_|  \\__  |\\____\\___/|_|  \\___|  ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "                                     |___/                      ");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "                                                                ");

    sLog->outInfo(LOG_FILTER_WORLDSERVER, "WoWArg 2005-2016");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "Visit our forum www.wowsource.info");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "WoWArgCore Cataclysm 4.3.4");
