...
class boss_lord_rhyolith: public CreatureScript
{
    public:
        ...
        struct boss_lord_rhyolithAI: public BossAI
        {
                ...
                // Timers
                // phase 1
                uint32 timerConcussiveStomp;
                uint32 timerSuperheated;
                uint32 timerThermalIgnition;
                uint32 timerThermalIgnition2;

                // phase 2
                uint32 timerUnleashedFlame;
                uint32 timerConcussiveStomp2;
            ...
            void InitializeAI()
            {
                ...
                void Reset()
                {
                    ...
                    speedRateLow = 0.2f;
                    speedRateNormal = 1.0f;

                    timerConcussiveStomp = 30000;
                    timerSuperheated = 10000;
                    timerThermalIgnition = 35000;
                    timerThermalIgnition2 = 35000;

                    timerUnleashedFlame = urand(15000, 20000);
                    timerConcussiveStomp2 = urand(35000, 45000);
