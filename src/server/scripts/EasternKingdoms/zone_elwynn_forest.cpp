    ...
    struct npc_hoggerAI : public ScriptedAI
    {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (HealthBelowPct(50))
            {
                ...
                if(!bSay)
                {
                    me->MonsterYell("Rayos! Ayuden a Hogger", 0, NULL);
                    bSay=true;
                }    
            }
            ...
            if(HealthBelowPct(35))
            {
                if(!bSay2)
                {
                    me->MonsterTextEmote("Hogger esta comiendo! Detenlo!", NULL, true);
                    bSay2=true;
                }
                if(!bGo1)
                {    
            ...
            if(HealthBelowPct(10))
            {
                if(!bSummoned3)
                {
                    if(!bSay3)
                    {
                        me->MonsterYell("No lastimar Hogger!", 0, NULL);
                        bSay3=true;
                    }
					...
					General->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC);
                ...
                if (m_uiPhaseTimer <= diff)
                {
                    ...
                    switch(phase)
                    {
                        ...
                        case 11:
                        {
							...
							General->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC);
