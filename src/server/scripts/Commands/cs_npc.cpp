...
public:
    ...
    */
    ...
    {
        char* tempCurrencyId = strtok((char*)args, " ");
        char* tempCurrencyCount = strtok(NULL, "");

        if (!tempCurrencyId || !tempCurrencyCount)
            return false;

        uint32 currencyId = atoi(tempCurrencyId);
        uint32 currencyCount = atoi(tempCurrencyCount);
